...
games = OrderedDict([
    ...
    ("dcss-0.29", dict(
        name = "DCSS 0.29 (current release)",
        ...
        morgue_path = "%%CHROOT_MORGUEDIR%%/%n/",
        morgue_url = "http://crawl.akrasiac.org/rawdata/%n/",
        inprogress_path = "%%CHROOT_INPROGRESSDIR%%-crawl29/",
        ttyrec_path = "%%CHROOT_TTYRECDIR%%/%n/",
        socket_path = "%%CHROOT_WEBDIR%%/sockets")),
    ("seeded-0.29", dict(
        name = "Custom seed 0.29",
        crawl_binary = "/bin/crawl-stable-launcher.sh",
        send_json_options = True,
        pre_options = [ "0.29" ],
        show_save_info = True,
        ...
        morgue_path = "%%CHROOT_MORGUEDIR%%/%n/",
        morgue_url = "http://crawl.akrasiac.org/rawdata/%n/",
        inprogress_path = "%%CHROOT_INPROGRESSDIR%%-crawl29-seeded/",
        ttyrec_path = "%%CHROOT_TTYRECDIR%%/%n/",
        socket_path = "%%CHROOT_WEBDIR%%/sockets",
        options = ["-seed"])),
    ("spr-0.29", dict(
        ...
        morgue_path = "%%CHROOT_MORGUEDIR%%/%n/",
        morgue_url = "http://crawl.akrasiac.org/rawdata/%n/",
        inprogress_path = "%%CHROOT_INPROGRESSDIR%%-crawl29-sprint/",
        ttyrec_path = "%%CHROOT_TTYRECDIR%%/%n/",
        socket_path = "%%CHROOT_WEBDIR%%/sockets",
        options = ["-sprint"])),

    ("dcss-0.28", dict(
        name = "DCSS 0.28 (previous release)",
        crawl_binary = "/bin/crawl-stable-launcher.sh",
        send_json_options = True,
        pre_options = [ "0.28" ],
        show_save_info = True,
        ...
        morgue_path = "%%CHROOT_MORGUEDIR%%/%n/",
        morgue_url = "http://crawl.akrasiac.org/rawdata/%n/",
        inprogress_path = "%%CHROOT_INPROGRESSDIR%%-crawl28/",
        ttyrec_path = "%%CHROOT_TTYRECDIR%%/%n/",
        socket_path = "%%CHROOT_WEBDIR%%/sockets")),
    ("seeded-0.28", dict(
        name = "Custom seed 0.28",
        crawl_binary = "/bin/crawl-stable-launcher.sh",
        send_json_options = True,
        pre_options = [ "0.28" ],
        show_save_info = True,
        ...
        morgue_path = "%%CHROOT_MORGUEDIR%%/%n/",
        morgue_url = "http://crawl.akrasiac.org/rawdata/%n/",
        inprogress_path = "%%CHROOT_INPROGRESSDIR%%-crawl28-seeded/",
        ttyrec_path = "%%CHROOT_TTYRECDIR%%/%n/",
        socket_path = "%%CHROOT_WEBDIR%%/sockets",
        options = ["-seed"])),
    ("spr-0.28", dict(
        ...
        morgue_path = "%%CHROOT_MORGUEDIR%%/%n/",
        morgue_url = "http://crawl.akrasiac.org/rawdata/%n/",
        inprogress_path = "%%CHROOT_INPROGRESSDIR%%-crawl28-sprint/",
        ttyrec_path = "%%CHROOT_TTYRECDIR%%/%n/",
        socket_path = "%%CHROOT_WEBDIR%%/sockets",
        options = ["-sprint"])),
    ...
    ("dcss-0.27", dict(
        ...
        morgue_path = "%%CHROOT_MORGUEDIR%%/%n/",
        morgue_url = "http://crawl.akrasiac.org/rawdata/%n/",
        inprogress_path = "%%CHROOT_INPROGRESSDIR%%-crawl27/",
        ttyrec_path = "%%CHROOT_TTYRECDIR%%/%n/",
        socket_path = "%%CHROOT_WEBDIR%%/sockets")),
    ("seeded-0.27", dict(
        name = "Custom seed 0.27",
        crawl_binary = "/bin/crawl-stable-launcher.sh",
        send_json_options = True,
        pre_options = [ "0.27" ],
        show_save_info = True,
        ...
        morgue_path = "%%CHROOT_MORGUEDIR%%/%n/",
        morgue_url = "http://crawl.akrasiac.org/rawdata/%n/",
        inprogress_path = "%%CHROOT_INPROGRESSDIR%%-crawl27-seeded/",
        ttyrec_path = "%%CHROOT_TTYRECDIR%%/%n/",
        socket_path = "%%CHROOT_WEBDIR%%/sockets",
        options = ["-seed"])),
    ("spr-0.27", dict(
        ...
        morgue_path = "%%CHROOT_MORGUEDIR%%/%n/",
        morgue_url = "http://crawl.akrasiac.org/rawdata/%n/",
        inprogress_path = "%%CHROOT_INPROGRESSDIR%%-crawl27-sprint/",
        ttyrec_path = "%%CHROOT_TTYRECDIR%%/%n/",
        socket_path = "%%CHROOT_WEBDIR%%/sockets",
        options = ["-sprint"])),

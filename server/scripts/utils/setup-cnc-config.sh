...
sed -i 's|<script type="text/javascript">|<script  type="text/javascript">\
      ...
      localStorage.DWEM_MODULES = JSON.stringify(\
        ["io-hook", "site-information", "websocket-factory", "rc-manager", "module-manager", "cnc-banner", "cnc-userinfo", "sound-support", "legacy-module-support", "cnc-chat", "cnc-public-chat", "convenience-module", "cnc-splash-screen"].map(m => "../modules/" + m + "/index.js")\

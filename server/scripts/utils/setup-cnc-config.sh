...
sed -i 's|<script type="text/javascript">|<script  type="text/javascript">\
      ...
      localStorage.DWEM_MODULES = JSON.stringify(\
        ["io-hook", "site-information", "websocket-factory", "rc-manager", "command-manager", "module-manager", "cnc-banner", "cnc-userinfo", "sound-support", "cnc-chat", "cnc-public-chat", "convenience-module", "cnc-splash-screen", "wtrec", "advanced-rc-editor", "translation-module"].map(m => "../modules/" + m + "/index.js")\
